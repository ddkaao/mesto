...
const popupProfile = document.querySelector('.popup__type_edit_profile');
const popupCards = document.querySelector('.popup__type_add_card');
const popupImage = document.querySelector('.popup__type_view_card');
const formElement = document.querySelector('.form__type-profile');
...
const formItem = document.querySelector('.form__type-card');
